                                                            ...
                                                            box.componentCode === "immunization" ? <Immunizations disabled={signed} patientId={patientId} encounterId={encounterId} isEditable={isEditable}/> :
                                                                box.componentCode === "chiefComplaint" ?
                                                                    <div className={classes.listSubChild} >
                                                                        <ChiefComplaint disabled={signed} encounterId={encounterId} patientId={patientId} updateChiefId={updateChief} isEditable={isEditable}  />
                                                                    </div> :
                                                                    box.componentCode === "vitals" ? <VitalSigns disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                        box.componentCode === "reviewOfSystem" ? <ReviewOfSystem disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                            box.componentCode === "physicalExam" ? <PhysicalExam disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                box.componentCode === "procedure" ? <Procedure disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                    box.componentCode === "labOrder" ? <OfficeTests disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                        box.componentCode === "imagingOrder" ? <LabImagingOrder disabled={signed} encounterId={encounterId} patientId={patientId} imagingOrder={true} isEditable={isEditable} /> :
                                                                                            box.componentCode === "checkoutNotes" ? <CheckoutNotes disabled={signed} encounterId={encounterId} patientId={patientId} patientAppointmentId={patientAppointmentId} isEditable={isEditable} /> :
                                                                                                box.componentCode === "chartNotes" ? <ChartNotes disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                    box.componentCode === "carePlan" ? <CarePlan disabled={signed} encounterId={encounterId} patientId={patientId} userLocationId={ulId} isEditable={isEditable} /> :
                                                                                                        box.componentCode === "patientInstructions" ? <PatientInstructionPlanOfCare disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                            box.componentCode === "cognitiveStatus" ? <CognitiveStatus disabled={signed} encounterId={encounterId} isEditable={isEditable} /> :
                                                                                                                box.componentCode === "functionalStatus" ? <FunctionalStatus disabled={signed} encounterId={encounterId} isEditable={isEditable} /> :
                                                                                                                    box.componentCode === "translationDocuments" ? <TranslationDocuments disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                    box.componentCode === "referral" ? <Referral disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                            box.componentCode === "superBill" ? <SuperBill disabled={!signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                                box.componentCode === "addendum" && signed ? <Addendum updateAddendum={updateEncounterlist} disabled={!signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                                    box.componentCode === "allergies_soap" ? <Allergies disabled={signed} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                                        box.componentCode === "diagnosis_soap" ? <Diagnosis disabled={signed} patientId={patientId} encounterId={encounterId} isEditable={isEditable} /> :
                                                                                                                                            box.componentCode === "history_soap" ? <History disabled={signed} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                                                box.componentCode === "medication_soap" ? <Medication disabled={signed} patientId={patientId} patientAppointmentId={patientAppointmentId} encounterId={encounterId} isEditable={isEditable} /> :
                                                                                                                                                    box.componentCode === "immunization_soap" ? <Immunizations disabled={signed} patientId={patientId} encounterId={encounterId} isEditable={isEditable}/>
                                                                                                                                                    : ""
                                        )}
                                    </div>
                                </div>
                                                                                                    ...
                                                                                                    box.componentCode === "patientInstructions" ? <PatientInstructionPlanOfCare disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                        box.componentCode === "cognitiveStatus" ? <CognitiveStatus disabled={signed} encounterId={encounterId} isEditable={isEditable} /> :
                                                                                                            box.componentCode === "functionalStatus" ? <FunctionalStatus disabled={signed} encounterId={encounterId} isEditable={isEditable} /> :
                                                                                                                ...
                                                                                                                box.componentCode === "referral" ? <Referral disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                        box.componentCode === "superBill" ? <SuperBill disabled={!signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                            box.componentCode === "screeningInterventions" ? <ScreeningInterventions disabled={signed} patientAppointmentId={patientAppointmentId} encounterId={encounterId} isEditable={isEditable} /> :
                                                                                                                                box.componentCode === "addendum" && signed ? <Addendum updateAddendum={updateEncounterlist} disabled={!signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} /> :
                                                                                                                                    box.componentCode == "chief_complaint_soap" ? <SoapChiefComplaint isUpdate={isUpdate} disabled={signed} encounterId={encounterId} patientId={patientId} updateChiefId={updateChief} isExpand={true} isEditable={isEditable} ></SoapChiefComplaint> :
                                                                                                                                        box.componentCode == "health_concerns_soap" ? <SoapHealthConcern isUpdate={isUpdate} disabled={signed} patientId={patientId} isExpand={true} isEditable={isEditable}></SoapHealthConcern> :
                                                                                                                                            box.componentCode == "subjective_soap" ? <SoapSubjectiveNotes isUpdate={isUpdate} disabled={signed} encounterId={encounterId} isExpand={true} subComponent={box.childs} isEditable={isEditable}></SoapSubjectiveNotes> :
                                                                                                                                                box.componentCode == "objective_soap" ? <SoapObjectiveNotes isUpdate={isUpdate} encounterId={encounterId} patientAppointmentId={patientAppointmentId} isExpand={true} subComponent={box.childs} patientId={patientId} disabled={signed} isEditable={isEditable}></SoapObjectiveNotes> :
                                                                                                                                                    box.componentCode == "assessment_soap" ? <SoapAssessment isUpdate={isUpdate} disabled={signed} encounterId={encounterId} patientId={patientId} isExpand={true} subComponent={box.childs} isEditable={isEditable}></SoapAssessment> :
                                                                                                                                                        box.componentCode == "plan_soap" ? <SoapPlan isUpdate={isUpdate} encounterId={encounterId} isExpand={true} subComponent={box.childs} disabled={signed} patientId={patientId} patientAppointmentId={patientAppointmentId} isEditable={isEditable}></SoapPlan> :
                                                                                                                                                            box.componentCode == "care_plan_soap" ? <SoapCaraPlan isUpdate={isUpdate} disabled={signed} encounterId={encounterId} patientId={patientId} userLocationId={ulId} isExpand={true} isEditable={isEditable}></SoapCaraPlan> :
                                                                                                                                                                box.componentCode == "documents_attached_to_encounter_soap" ? <SoapTranslationDocument isUpdate={isUpdate} disabled={signed} encounterId={encounterId} patientId={patientId} isExpand={true} isEditable={isEditable}></SoapTranslationDocument> :
                                                                                                                                                                    box.componentCode == "quality_of_care_soap" ? <QualityOfCare isUpdate={isUpdate} disabled={signed} encounterId={encounterId} isExpand={true} isEditable={isEditable}></QualityOfCare> :
                                                                                                                                                                    box.componentCode == "referral_soap" ? <SoapReferral isUpdate={isUpdate} disabled={signed} encounterId={encounterId} patientId={patientId} isEditable={isEditable} isExpand={true}></SoapReferral> :
                                                                                                                                                                            box.componentCode == "superbill_soap" ? <SoapSuperBill isUpdate={isUpdate} disabled={!signed} encounterId={encounterId} patientId={patientId} isExpand={true} isEditable={isEditable}></SoapSuperBill> : ''
