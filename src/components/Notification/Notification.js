...
export default function Notification({
  ...
  return ( <
    div className = {
      classnames(classes.notificationContainer, props.className, {
    ...
    <
    div className = {
      classnames(classes.notificationIconContainer, {
    ...
    size = {
      variant !== "contained" && !props.typographyVariant && "md"
    } >
    {
      props.message
    } <
